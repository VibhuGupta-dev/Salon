  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.from(".footer-divider", {
        scaleX: 0, duration: 1.2, stagger: 0.1, ease: "expo.out",
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <div>
          ...
          <h2 style={{
            ...
            margin: 0, color: "#f5ede0",
          }}>
            Floyd's <span style={{ color: "#c9a87c" }}>Barber</span>
          </h2>
          <p style={{
            fontSize: 11, color: "rgba(245,237,224,0.3)",
            margin: "0.75rem 0 0", letterSpacing: "0.1em", textTransform: "uppercase",
          }}>
        ...
        <a
          ...
          onMouseEnter={e => {
            ...
            e.currentTarget.style.color = "#1e0d04";
          }}
          onMouseLeave={e => {
          ...
          style={{
            ...
            background: "transparent", fontWeight: 500, alignSelf: "flex-start",
          }}
        >
          Book Appointment →
        </a>
      ...
      <div ref={colsRef} style={{
        maxWidth: 1200, margin: "0 auto",
        padding: isMobile ? "2.5rem 1.25rem 3rem" : "4rem 2.5rem",
        display: "grid",
        ...
        {/* About */}
        <div className="footer-col" style={{ gridColumn: isMobile ? "1 / -1" : "auto" }}>
          <div className="footer-divider" style={{ height: 1, background: "rgba(201,168,124,0.2)", marginBottom: "1.5rem" }} />
          <p style={label}>About</p>
          <p style={{
            fontSize: 13, color: "rgba(245,237,224,0.35)", lineHeight: 1.8,
            fontWeight: 300, letterSpacing: "0.02em", margin: "0 0 1.25rem",
          ...
          <div style={{ display: "flex", gap: "0.6rem", flexWrap: "wrap" }}>
            {SOCIALS.map(s => (
              <a
                ...
                onMouseEnter={e => {
                  e.currentTarget.style.borderColor = "rgba(201,168,124,0.6)";
                  e.currentTarget.style.color = "#f5ede0";
                }}
                onMouseLeave={e => {
                  e.currentTarget.style.borderColor = "rgba(201,168,124,0.2)";
                  e.currentTarget.style.color = "rgba(201,168,124,0.6)";
                }}
                style={{
                  padding: "0.38rem 0.85rem",
                  border: "1px solid rgba(201,168,124,0.2)",
                  color: "rgba(201,168,124,0.6)", fontSize: 9,
        ...
        <div className="footer-col" style={{ gridColumn: isMobile ? "1 / -1" : "auto" }}>
          <div className="footer-divider" style={{ height: 1, background: "rgba(201,168,124,0.2)", marginBottom: "1.5rem" }} />
          <p style={label}>Visit Us</p>

          <p style={{ ...label, marginBottom: "0.5rem", letterSpacing: "0.3em" }}>Hours</p>
          {[["Mon – Fri", "9:00am – 7:00pm"], ["Saturday", "9:00am – 6:00pm"], ["Sunday", "Closed"]].map(([day, time]) => (
            <div key={day} style={{ display: "flex", justifyContent: "space-between", marginBottom: "0.5rem", fontSize: 12 }}>
          ...
          <div style={{ marginTop: "1.5rem" }}>
            <p style={{ ...label, marginBottom: "0.4rem", letterSpacing: "0.3em" }}>Address</p>
            <p style={{
              fontSize: 12, color: "rgba(245,237,224,0.35)", lineHeight: 1.75,
      ...
      <div ref={bottomRef} style={{ borderTop: "1px solid rgba(245,237,224,0.06)", position: "relative", zIndex: 1 }}>
        <div style={{
          ...
          <div style={{ display: "flex", gap: isMobile ? "1.25rem" : "2rem" }}>
            {["Privacy Policy", "Terms of Service"].map(t => (
              <a
                ...
                style={{
                  fontSize: 10, color: "rgba(245,237,224,0.2)",
          ...
          <p style={{
            fontSize: 10, color: "rgba(245,237,224,0.12)", margin: 0,
            fontFamily: "'Playfair Display', serif", fontStyle: "italic",
          }}>
...
const label = {
  ...
  color: "rgba(201,168,124,0.5)", marginBottom: "1rem",
};

const navLink = {
  display: "block", fontSize: 13, color: "#7a5c44",
  textDecoration: "none", letterSpacing: "0.02em",
  marginBottom: "0.9rem", fontWeight: 300,
