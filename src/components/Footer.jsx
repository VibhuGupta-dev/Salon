...
export default function Footer() {
  ...
  return (
    <footer ref={footerRef}
      ...
      {/* ── BIG DECORATIVE WORD ──────────────────────────────────────────── */}
      <div ref={bigWordRef} style={{ position: "absolute", bottom: 60, left: "50%",
                                      transform: "translateX(-50%)", pointerEvents: "none",
                                      zIndex: 0, whiteSpace: "nowrap" }}>
        <span style={{ fontFamily: "'Playfair Display',serif", fontStyle: "italic",
                        fontSize: "clamp(6rem,14vw,12rem)", fontWeight: 300,
      ...
      {/* ── TOP HERO STRIP ───────────────────────────────────────────────── */}
      <div style={{ borderBottom: "1px solid rgba(245,237,224,0.06)",
                    padding: "5rem 2.5rem 4.5rem", maxWidth: 1200, margin: "0 auto",
        ...
        <div>
          ...
          <p style={{ fontSize: 10, letterSpacing: "0.5em", textTransform: "uppercase",
                       color: "rgba(212,196,168,0.4)", margin: "0 0 1rem" }}>
            Est. 2018 · Lucknow
          </p>
          ...
          <p style={{ fontSize: 12, color: "rgba(245,237,224,0.3)", margin: "1rem 0 0",
                       letterSpacing: "0.1em", textTransform: "uppercase" }}>
            Precision · Craft · Character
          </p>
        </div>

        {/* Book CTA in footer hero */}
        <a href="#contact" onClick={e => smoothScroll(e, "#contact")}
          ...
          style={{ padding: "0.9rem 2.2rem", border: "1px solid rgba(201,168,124,0.35)",
      ...
      {/* ── COLUMNS ──────────────────────────────────────────────────────── */}
      <div ref={colsRef} style={{ maxWidth: 1200, margin: "0 auto",
        ...
        <div className="footer-col">
          <div className="footer-divider" style={{ height: 1, background: "rgba(201,168,124,0.2)",
                                                    marginBottom: "1.8rem" }}/>
          <p style={{ fontSize: 9, letterSpacing: "0.4em", textTransform: "uppercase",
                       color: "rgba(201,168,124,0.5)", marginBottom: "1rem" }}>About</p>
          <p style={{ fontSize: 13, color: "rgba(245,237,224,0.35)", lineHeight: 1.8,
                       fontWeight: 300, letterSpacing: "0.02em", margin: "0 0 1.5rem" }}>
          ...
          <div style={{ display: "flex", gap: "0.7rem", flexWrap: "wrap" }}>
            {SOCIALS.map(s => (
              <a key={s.name} href={s.href}
                ...
                style={{ padding: "0.4rem 0.9rem", border: "1px solid rgba(201,168,124,0.2)",
        ...
        <div className="footer-col">
          <div className="footer-divider" style={{ height: 1, background: "rgba(201,168,124,0.2)",
                                                    marginBottom: "1.8rem" }}/>
          <p style={{ fontSize: 9, letterSpacing: "0.4em", textTransform: "uppercase",
                       color: "rgba(201,168,124,0.5)", marginBottom: "1.2rem" }}>Navigate</p>
          {NAV.map(link => (
            <a key={link.label} href={link.href}
              ...
              style={{ ...linkStyle, transition:"color 0.25s ease, padding-left 0.3s ease" }}>
              {link.label}
            </a>
          ))}
        </div>
        ...
        <div className="footer-col">
          <div className="footer-divider" style={{ height: 1, background: "rgba(201,168,124,0.2)",
                                                    marginBottom: "1.8rem" }}/>
          <p style={{ fontSize: 9, letterSpacing: "0.4em", textTransform: "uppercase",
                       color: "rgba(201,168,124,0.5)", marginBottom: "1.2rem" }}>Services</p>
          {SERVICES.map(s => (
        ...
        <div className="footer-col">
          <div className="footer-divider" style={{ height: 1, background: "rgba(201,168,124,0.2)",
                                                    marginBottom: "1.8rem" }}/>
          <p style={{ fontSize: 9, letterSpacing: "0.4em", textTransform: "uppercase",
                       color: "rgba(201,168,124,0.5)", marginBottom: "1.2rem" }}>Visit Us</p>

          <p style={{ fontSize: 9, letterSpacing: "0.3em", textTransform: "uppercase",
                       color: "rgba(201,168,124,0.4)", margin: "0 0 0.4rem" }}>Hours</p>
          {[["Mon – Fri", "9:00am – 7:00pm"], ["Saturday", "9:00am – 6:00pm"], ["Sunday", "Closed"]].map(([day, time]) => (
            <div key={day} style={{ display: "flex", justifyContent: "space-between",
                                     marginBottom: "0.5rem", fontSize: 12 }}>
          ...
          <div style={{ marginTop: "1.8rem" }}>
            <p style={{ fontSize: 9, letterSpacing: "0.3em", textTransform: "uppercase",
                         color: "rgba(201,168,124,0.4)", margin: "0 0 0.5rem" }}>Address</p>
            <p style={{ fontSize: 12, color: "rgba(245,237,224,0.35)", lineHeight: 1.7,
                         fontFamily:"'Playfair Display',serif", fontWeight:300, margin:0 }}>
      ...
      {/* ── BOTTOM BAR ───────────────────────────────────────────────────── */}
      <div ref={bottomRef} style={{ borderTop: "1px solid rgba(245,237,224,0.06)",
                                     position: "relative", zIndex: 1 }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "1.8rem 2.5rem",
                       display: "flex", alignItems: "center", justifyContent: "space-between",
                       flexWrap: "wrap", gap: "1rem" }}>
          <p style={{ fontSize: 10, color: "rgba(245,237,224,0.2)", margin: 0,
          ...
          <div style={{ display: "flex", gap: "2rem" }}>
            {["Privacy Policy", "Terms of Service"].map(t => (
              <a key={t} href="#"
                ...
                style={{ fontSize: 10, color: "rgba(245,237,224,0.2)",
          ...
          <p style={{ fontSize: 10, color: "rgba(245,237,224,0.12)", margin: 0,
