    ...
    >
      ...
      <div
        style={{
          ...
          zIndex: 1,
          background:
            "linear-gradient(to bottom, rgba(0,0,0,0.55) 0%, rgba(0,0,0,0.45) 60%, rgba(0,0,0,0.7) 100%)",
        }}
      />
      ...
      {'Redefined'.split('').map((c, i) => (
        ...
        <div
          ...
          style={{
            width: 60,
            height: 1,
            background: "rgba(201,184,152,0.45)",
            margin: "2rem auto",
          }}
        />
        ...
        >
          ...
          <a
            ...
            style={{
              padding: "0.9rem 2.5rem",
              border: "1px solid rgba(201,184,152,0.28)",
              color: "#c9b898",
              fontWeight: 300,
              fontSize: 11,
              letterSpacing: "0.15em",
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            height: 48,
            background:
              "linear-gradient(to bottom, rgba(201,184,152,0.4), transparent)",
          }}
        />
      </div>
    </section>
